...
<div class="row">
  <div class="main-content col-md-8 col-md-offset-2">
    ...
    <p>
      Functional languages and Clojure in particular allows developers to: <br> be more concise; <br> trivially generate universal abstractions; <br> compose functions repeatedly; <br> reuse code and;<br> realize write-once, run-forever investment. <br> Clojure was built from the ground up with concurrency in mind and thus offers major performance gains. It has seamless interoperability with the expansive Java ecosystem. ClojureScript has the same advantages implementing JavaScript via the Google Closure Library.
    </p>
    <p>
